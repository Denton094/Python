  ...
  for dirpath, dirs, files in os.walk(start_dir):
    for single_file in files:
      if fnmatch.fnmatch(single_file, "*txt") or fnmatch.fnmatch(single_file,"*log"): 
        ...
        name_file = single_file
        store_top = (filepath,name_file)
        store.append(store_top)
        print("Creating a tuple with {0} file content and {1} path". format(name_file,filepath))
